...
namespace RonSijm.Blazyload.MicrosoftServiceProvider
{
    ...
    {
        internal static CallSiteJsonFormatter Instance = new();
        ...
        protected override object VisitIEnumerable(EnumerableCallSite enumerableCallSite, CallSiteFormatterContext argument)
        {
